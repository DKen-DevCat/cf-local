...
// DefaultEdgeProxyURL は Phase 4-D 4d-7 で Lambda@Edge bridge を経由する際に
// nginx の `set $cf_edge_proxy "..."` directive にデフォルトで埋め込む値。
// docker-compose.lambda.yml の network 内サービス名を参照する。本番運用時は
