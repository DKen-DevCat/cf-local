...
- [x] 1-3 `cache_key.js` 実装（テストファースト / β 16 件 PASS — bash harness は 1-6 で Go 化）
...
- [x] 1-6 テストハーネス整備（Go 1 本: β 16 + α 4 = 20 件 PASS）
- [x] 1-7 `docs/cache-policy.md` 整備 + `examples/` 拡充 (`docs/limitations.md` も Phase 1 反映)
